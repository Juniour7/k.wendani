...
const Development = () => {
  ...
  return (
    <>
        <section className='bg-[#F8F8F8] px-3 md:px-0 py-[20px] md:pb-[50px]'>
            <div className='text-center mb-2 md:mb-6'>
                ...
                <div className="h-[250px] flex-shrink-0 rounded-lg mt-[20px] md:hidden">
                    <Slider {...settings}>
            ...
            <div className='md:flex  justify-center  gap-5'>
                <div className='basis-[40%] space-y-3'>
                    ...
                    <Link to="/giving"><button className='bg-[#007681] mt-[20px] md:mt-[50px] text-[#F0B323] rounded-md text-xl font-semibold px-6 py-2  hover:bg-[#F0B323] hover:text-[#007681] hover:border-0 transition-colors duration-300 transform ease-in-out'>Donate Now</button></Link>
                </div>

                {/* Carousel Part */}
                <div className="basis-[50%] md:w-[40%] h-[250px] md:h-[450px] flex-shrink-0 rounded-lg  hidden md:block">
                    <Slider {...settings}>
                        {images.map((image, index) => (
